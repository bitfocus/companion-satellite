import type { SurfaceRotation, SurfaceSchemaBitmapConfig } from '@companion-surface/host'
import { Canvas } from '@napi-rs/canvas'
import type { LockingGraphicsGenerator } from '@companion-surface/host'
...
export class LockingGraphicsGeneratorImpl implements LockingGraphicsGenerator {
	async generatePincodeChar(
		...
		return this.#transformForPixelFormat(bitmapStyle, rawData, rotation)
	}
